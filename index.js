...
{
"ref":"pandare.PandaPlugin",
"url":0,
"doc":"Base class which PyPANDA plugins should inherit. Subclasses may register callbacks using the provided panda object and use PandaPlugin.get_args or PandaPlugin.get_arg_bool to check argument values (note these helpers should be accessed with  self.get_ . ). This PyPANDA extra aims to mirror the snake_hook (rust) plugin so a single PyPANDA plugin can be used from both pure PyPANDA (with this class) or from CLI panda with snake_hook. For more information, read the snake_hook documentation"
},
{
"ref":"pandare.PandaPlugin.get_arg",
"url":0,
...
{
"ref":"pandare.PandaPlugin.get_arg_bool",
"url":0,
"doc":"returns True if the argument is True",
"func":1
},
{
"ref":"pandare.panda_plugin",
"url":1,
"doc":""
},
{
"ref":"pandare.panda_plugin.PandaPlugin",
"url":1,
"doc":"Base class which PyPANDA plugins should inherit. Subclasses may register callbacks using the provided panda object and use PandaPlugin.get_args or PandaPlugin.get_arg_bool to check argument values (note these helpers should be accessed with  self.get_ . ). This PyPANDA extra aims to mirror the snake_hook (rust) plugin so a single PyPANDA plugin can be used from both pure PyPANDA (with this class) or from CLI panda with snake_hook. For more information, read the snake_hook documentation"
},
{
"ref":"pandare.panda_plugin.PandaPlugin.get_arg",
"url":1,
"doc":"returns either the argument as a string or None if the argument wasn't passed (arguments passed in bool form (i.e., set but with no value) instead of key/value form will also return None).",
"func":1
},
{
"ref":"pandare.panda_plugin.PandaPlugin.get_arg_bool",
"url":1,
"doc":"returns True if the argument is True",
"func":1
},
...
{
"ref":"pandare.pyplugin.PyPluginManager",
"url":4,
"doc":"Set up an instance of PyPluginManager."
},
{
"ref":"pandare.pyplugin.PyPluginManager.enable_flask",
"url":4,
...
{
"ref":"pandare.pyplugin.PyPluginManager.load_plugin_class",
"url":4,
"doc":"For backwards compatability with PyPlugins which subclass PandaPlugin without importing it. Given a path to a python file which has a class that subclasses PandaPlugin, set up the imports correctly such that we can generate an uninstantiated instance of that class and return that object. Note you can also just add  from pandare import PandaPlugin to the plugin file and then just import the class(es) you want and pass them directly to panda.pyplugin.register() This avoids the  NameError: name 'PandaPlugin' is not defined which you would get from directly doing  import [class_name] from [plugin_file] ",
"func":1
},
{
"ref":"pandare.pyplugin.PyPluginManager.register",
"url":4,
"doc":"Register a PyPANDA plugin to run. It can later be unloaded by using panda.pyplugin.unregister(name). pluginclass can either be an uninstantiated python class or a tuple of (path_to_module.py, classname) where classname subclasses PandaPlugin. If name is unspecified, a string representation of the class will be used instead",
"func":1
},
{
"ref":"pandare.pyplugin.PyPluginManager.unregister",
"url":4,
"doc":"",
"func":1
},
{
"ref":"pandare.pyplugin.PyPluginManager.is_registered",
"url":4,
"doc":"",
"func":1
},
{
"ref":"pandare.pyplugin.PyPluginManager.serve",
"url":4,
"doc":"",
"func":1
},
...
{
"ref":"pandare.panda.Panda.pyplugin",
"url":6,
"doc":"A reference to an auto-instantiated  pandare.pyplugin.PyPluginManager class."
},
{
